...
class cache():
    ...
    def __init__(self, ID, size, line_size, mem_size):
        self.cache_ID = ID
...
class direct_cache(cache):
    ...
    def __init__(self, ID, size = 128, line_size = 8, mem_size = 512):
        super().__init__(ID, size, line_size, mem_size)
...
class nway_cache(cache):
    ...
    def __init__(self, ID, size = 128, line_size = 8, mem_size = 512, way = 2):
        super().__init__(ID, size, line_size, mem_size)
        self.way = way
        # For LSR
        self.line_queue = []
...
# c = direct_cache(0)
# print(c.operation("st", 66))
# print(c.operation("st", 332))
# print(c.operation("st", 167))
# print(c.operation("st", 66))
# c.print_cache()